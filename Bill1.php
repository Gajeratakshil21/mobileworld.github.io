...
<body>
   ...
   <div class="foot">
       <div class="foot-left">
           ...
           <?php
                $qq="select *from bill where b_id=".$_GET['b_id'];
...
<p><?php echo $r1['name'];?></h4><br><br>
<p>shipping Address :<?php echo $r1['s_add'];echo  '   ,   '.$r1['city'];echo '  -   '.$r1['pincode']?></p><br>
<p>Billing Address :<?php echo $r1['b_add'];echo  '   ,   '.$r1['city'];echo '  -   '.$r1['pincode']?></p><br>
<p>Pincode <?php echo '  -   '.$r1['pincode']?></p><br>
       ...
       echo '<tr>';
        ...
        while($row=mysqli_fetch_array($result1))
        {
         echo '<tr>';
            ...
            echo '<td align="center"><a href="mobile_detail.php?id='.$r[0].'"><img src="admin/image/'.$r[21].'" width="90" height="90"></a>';
